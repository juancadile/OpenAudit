...
class ProviderError(ModelError):
    ...
    def __init__(self, message: str, provider: str, error_code: str = None, details: Dict[str, Any] = None):
...
class FileProcessingError(DataError):
    ...
    def __init__(self, message: str, file_path: str, error_code: str = None, details: Dict[str, Any] = None):
...
class TemplateNotFoundError(TemplateError):
    ...
    def __init__(self, template_name: str, template_type: str = "unknown"):
        ...
        message = f"{template_type.title()} template not found: {template_name}"
        details = {
...
class InsufficientDataError(DataError):
    ...
    def __init__(self, required_count: int, actual_count: int, data_type: str = "data points"):
...
class InvalidFormatError(ValidationError):
    ...
    def __init__(self, expected_format: str, actual_format: str = None, field_name: str = None):
...
def handle_provider_error(error: Exception, provider: str) -> ProviderError:
    ...
    if any(keyword in error_message.lower() for keyword in ["api key", "authentication", "unauthorized", "invalid key"]):
        return APIKeyError(
    ...
    # Rate limit errors
    if any(keyword in error_message.lower() for keyword in ["rate limit", "quota", "too many requests"]):
...
def validate_experiment_config(config: Dict[str, Any]) -> None:
    ...
    if not isinstance(config["models"], list) or not config["models"]:
        raise ValidationError(
            ...
            details={"models": config.get("models")}
        )

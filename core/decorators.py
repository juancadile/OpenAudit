...
def api_error_handler(func: Callable) -> Callable:
    ...
    def wrapper(*args, **kwargs):
        try:
            ...
            logger.warning(f"OpenAudit error in {func.__name__}: {e.message}", extra=e.details)
...
def validate_experiment_id(func: Callable) -> Callable:
    ...
    def wrapper(*args, **kwargs):
        ...
        experiment_id = kwargs.get('experiment_id') or request.view_args.get('experiment_id')
